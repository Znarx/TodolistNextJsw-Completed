...
const TodoList = () => {
  ...
  return ( 
    <div className="flex items-center justify-center h-screen" style={{ backgroundImage: 'url(https://t4.ftcdn.net/jpg/04/61/47/03/360_F_461470323_6TMQSkCCs9XQoTtyer8VCsFypxwRiDGU.jpg)', backgroundSize: 'contain' }}>
                        ...
                        {tabName === 'Todo List' && (
                          <div className="flex items-center space-x-2">
                            <button
                              ...
                              className={classNames(
                                'rounded-md px-2 py-1 ml-3 text-sm bg-white-500 text-black focus:outline-none',
                                'hover:bg-yellow-600',
                            ...
                            <button
                              ...
                              className={classNames(
                                'rounded-md px-2 py-1 text-sm bg-white-500 text-black focus:outline-none',
                                'hover:bg-red-600',
                                'transform-gpu transition-transform hover:scale-110'
                              )}
                            >
